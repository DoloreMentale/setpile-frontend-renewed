    ...
    >
          ...
          <a-row :gutter="[16, 24]">
            ...
            <a-col :span="24">
              ...
              <a-form-item label="Your location">
                <InputGeo
                  :value="user.geo_place"
                  @input="user.geo_place = $event"
                />
              </a-form-item>
              <a-form-item
            ...
            <a-col :span="24" class="user-buttons">
              ...
              >
              <a-button
                v-if="getEmailVerifyed()"
                type="primary"
                size="large"
                @click="resendConfirmation()"
                >Resend confirmation email</a-button
              >
            </a-col>
          </a-row>
        </form>
          ...
          <a-row :gutter="[24, 24]">
            ...
            <a-col :xs="24" :md="12">
              <a-form-item label="Current password">
                <a-input-password
                  v-model="password_current_email"
                  size="large"
                  required
                />
              </a-form-item>
          ...
          <a-row :gutter="[24, 24]">
            ...
            <a-col :xs="24" :md="8">
              <a-form-item label="New password">
                <a-input-password v-model="password" size="large" required />
              </a-form-item>
            </a-col>
            <a-col :xs="24" :md="8">
            ...
            <a-col :xs="24" :md="24">
              <a-space direction="vertical" :size="16">
                ...
                >
                <a-button type="link" size="large" @click="passForgot()"
      ...
      <a-col :xs="24" :md="24">
        <a-row type="flex" justify="space-between">
          ...
          <a-button type="link" @click="redirectToBillingPortal()"
            >Manage billing</a-button
          >
        </a-row>
        <br />
...
const isCanceled = () => {
  return (
    user.value &&
    user.value.subscription &&
    user.value.subscription.status === "canceled"
  );
};
...
const getMonthlyPriceValue = () => {
  if (
    ...
    this.user.subscription.billing_period_price
  ) {
...
const getCurrentPeriodEndMonth = () => {
  if (
    this.user &&
    this.user.subscription &&
    this.user.subscription.current_period_end
  ) {
