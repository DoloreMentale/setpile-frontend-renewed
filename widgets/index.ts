...
export { default as SendOfferModal } from "~/widgets/modals/send-offer/index.vue";
export { default as ResetPasswordModal } from "~/widgets/modals/reset-password/index.vue";
export { default as VerifyEmailModal } from "~/widgets/modals/verify-email/index.vue";
